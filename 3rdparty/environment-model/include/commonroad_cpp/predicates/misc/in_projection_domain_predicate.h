...
/**
 * Predicate which checks if the kth vehicle is within the CCS projection domain of the pth vehicle.
 */
class InProjectionDomainPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for InProjectionDomainPredicate.
     */
    InProjectionDomainPredicate();
