...
/**
 * Dummy predicate for evaluating high computation times. Sleeps for 2000ms and returns true.
 */
class HighComputationTimeTestPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for HighComputationTimeTestPredicate
     */
    HighComputationTimeTestPredicate();
