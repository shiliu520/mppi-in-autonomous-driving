...
/**
 * Predicate which checks whether the kth vehicle is in front of a traffic light.
 */
class RelevantTrafficLightPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for AtRedLeftTrafficLightPredicate.
     */
    RelevantTrafficLightPredicate();
