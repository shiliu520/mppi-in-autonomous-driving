...
/**
 * Evaluates whether a vehicle keeps its braking based speed limit. This is necessary to ensure that a vehicle
 * is able to react without unnecessary braking to an upcoming speed limit.

 */
class KeepsBrakingSpeedLimitPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for KeepsBrakingSpeedLimitPredicate.
     */
    KeepsBrakingSpeedLimitPredicate();
