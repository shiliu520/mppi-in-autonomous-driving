...
/**
 * Predicate which checks if the kth vehicle brakes.
 */
class DeceleratesPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for DeceleratesPredicate.
     */
    DeceleratesPredicate();
