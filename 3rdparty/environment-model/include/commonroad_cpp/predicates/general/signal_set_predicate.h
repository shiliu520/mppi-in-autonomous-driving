...
/**
 * Predicate evaluates whether a vehicle has a signal set. The signal name is provided as parameter.
 */
class SignalSetPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for SignalSetPredicate
     */
    SignalSetPredicate();
