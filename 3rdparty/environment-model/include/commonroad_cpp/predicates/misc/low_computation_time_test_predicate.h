...
/**
 * Dummy predicate for evaluating low computation times. Sleeps for 5ms and returns true.
 */
class LowComputationTimeTestPredicate : public CommonRoadPredicate {
  public:
    /**
     * Constructor for LowComputationTimeTestPredicate
     */
    LowComputationTimeTestPredicate();
